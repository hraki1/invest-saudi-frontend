...
export default function SuccessStories() {
  ...
  return (
    <section className="relative w-full py-12 sm:py-16 md:py-20 lg:py-24 bg-[#08141f] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 min-[375px]:px-5 sm:px-6 md:px-8 lg:px-12 xl:px-16 overflow-visible">
        {/* Title */}
        ...
        <div
          ...
          } px-4 min-[375px]:px-5 sm:px-6 md:px-8 lg:px-12 xl:px-16 overflow-visible`}
        >
          {/* Swiper Carousel */}
            ...
            >
              {successStories.map((story) => (
                <SwiperSlide key={story.id} className="!h-auto stacked-slide">
                  <div
                    className={`!w-[90vw] min-[375px]:!w-[85vw] sm:!w-[500px] md:!w-[550px] lg:!w-[600px] xl:!w-[650px] 2xl:!w-[900px] h-full  rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 ${
                      story.gradient
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-2 h-full min-h-[280px] min-[375px]:min-h-[320px] sm:min-h-[380px] md:min-h-[420px] lg:min-h-[460px]">
                      ...
                      <div className="relative min-h-[180px] min-[375px]:min-h-[200px] sm:min-h-[240px] md:min-h-[280px] lg:min-h-0 lg:h-full">
