          ...
          >
            {filteredEvents.map((event) => (
              <SwiperSlide key={event.id} className="overflow-hidden">
                <div className="h-full overflow-hidden bg-gradient-to-br from-purple-800/90 to-blue-900/90 backdrop-blur-sm border border-white/10 shadow-lg transition-transform duration-300">
                  <div className="flex flex-col lg:flex-row h-full">
                    ...
                    <div className="w-full lg:w-1/2 p-4 sm:p-6 md:p-8 flex flex-col justify-between">
                      ...
                      <div className="flex items-center gap-1.5 sm:gap-2 text-white/90 mb-2 sm:mb-3">
                        <HiMapPin className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />
                      ...
                      <div className="flex items-center gap-1.5 sm:gap-2 text-white/90 mb-3 sm:mb-4">
                        <HiCalendar className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />
                      ...
                      {/* Description */}
                      <p className="text-white/80 text-xs sm:text-sm md:text-base mb-4 sm:mb-6 leading-relaxed flex-grow line-clamp-3 sm:line-clamp-none">
                        {event.description}
                      </p>
