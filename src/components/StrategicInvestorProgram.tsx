...
export default function StrategicInvestorProgram() {
      ...
      icon: (
        ...
        >
          ...
          <defs>
            ...
            >
              <stop offset="0.0558172" stop-color="#E6F6F6" />
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#003A39] to-[#006461]">
            ...
            {keyMetrics.map((metric, index) => (
              ...
              >
                <div className="flex flex-col md:pb-5 items-start gap-4">
                  {/* Icon Circle */}
                  <div
                    className={`w-14 h-14 rounded-full  ${metric.iconBg} flex items-center justify-center flex-shrink-0 text-white`}
                  >
                    {metric.icon}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-4 lg:gap-8 items-center">
            ...
            <div className="space-y-4 h-full flex flex-col justify-between">
              {pillars.map((pillar, index) => (
                <div
                  key={index}
                  className="group relative bg-gradient-to-r from-black/40 via-black/20 to-translaprent backdrop-blur-sm rounded-xl p-3 md:p-5 lg:p-6 2xl:p-8 transition-all duration-300 cursor-pointer"
                >
                  <div className="flex items-center gap-5 md:gap-6 lg:gap-[26px]">
                    ...
                    <span className="relative mr-2 text-6xl md:text-[64px] font-light text-white/20 group-hover:text-white/30 transition-colors">
                      {pillar.number}
                      <span className="absolute top-0 -right-3 w-[1px] h-full rounded-full bg-gradient-to-b from-transparent via-white/20 to-transparent"></span>
                    </span>
                    ...
                    {/* Arrow Icon */}
                    <div className="w-8 h-8 -rotate-45 rounded-full bg-black/40 flex items-center justify-center border border-white/20 group-hover:bg-white/10 group-hover:border-white/30 transition-all flex-shrink-0 mt-2">
